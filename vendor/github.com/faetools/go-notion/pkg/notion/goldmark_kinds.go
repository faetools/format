...
var (
	...
	// GoldmarkKindBookmark is a ast.NodeKind of the GoldmarkBookmark node.
	GoldmarkKindBookmark = ast.NewNodeKind("Bookmark")
...
type (
	...
	// A GoldmarkBookmark struct represents a bookmark in Notion.
	GoldmarkBookmark struct {
		ast.BaseInline
		URL string
	}
...
// Kind implements Node.Kind.
func (n *GoldmarkBookmark) Kind() ast.NodeKind { return GoldmarkKindBookmark }
...
// Dump implements Node.Dump.
func (n *GoldmarkBookmark) Dump(source []byte, level int) {
