...
type Block struct {
	...
	NumberedListItem *map[string]interface{} `json:"numbered_list_item,omitempty"`
	...
	TableOfContents *map[string]interface{} `json:"table_of_contents,omitempty"`
	TableRow        *map[string]interface{} `json:"table_row,omitempty"`
	Template        *Template               `json:"template,omitempty"`
	ToDo            *map[string]interface{} `json:"to_do,omitempty"`
	Toggle          *map[string]interface{} `json:"toggle,omitempty"`
...
type Database struct {
	...
	Properties PropertyMetas `json:"properties"`
